  ...
  return (
    <div>
        <div className="">
            ...
            {/* first */}
            <div className="container  px-4 sm:px-8 pt-10 pb-16 flex flex-col gap-3 md:flex-row bg-green-100">
            ...
            {/* second */}
            <div className="container px-4 sm:px-8 pt-12 pb-16 flex flex-col gap-5 md:grid md:grid-cols-2  ">
            ...
            {/*third*/}
            <div className="container pt-12 pb-16 px-4 sm:px-8 flex flex-col md:grid md:grid-cols-2 md:gap-2 bg-green-100 ">
                ...
                <div className="flex flex-col space-y-6 md:grid md:grid-cols-2 md:space-y-0 md:gap-4">
                    ...
                    <div className="flex flex-col space-y-4 border border-brandPrimary shadow-lg rounded-lg py-4 px-4 ">
                        ...
                        <button className='px-3 py-2 w-2/5 md:w-full bg-brandPrimary rounded-lg text-sm font-bold text-white'><a href="/partenariats">Cliquez Ici</a></button>
                    </div>
                    {/*end of cart*/}
                    ...
                    <div className="flex flex-col space-y-4 border border-brandPrimary shadow-lg rounded-lg py-4 px-4 ">
                        ...
                        <button className='px-3 py-2 w-2/5 md:w-full bg-brandSecondary rounded-lg text-sm font-bold text-white'><a href="/partenariats">Cliquez Ici</a></button>
                    </div>
                    {/*end of cart*/}
                </div>
            </div>
